...
<script type="text/javascript" src="../static/js/timeStats.js"></script>
...
<tr><th>时间:</th><td><input id="search_beginDate" type="text" class="easyui-datebox" data-options="editable:false,width:150"/>至<input id="search_endDate" type="text" class="easyui-datebox" data-options="editable:false,width:150"/></td><th>金额:</th><td><input id="search_beginMoney" class="easyui-numberbox" data-options="min:0,precision:2,width:150"/>至<input id="search_endMoney" class="easyui-numberbox" data-options="min:0,precision:2,width:150"/></td><th>统计维度:</th><td class="lastCol"><select id="search_groupBy"></select></td></tr>
