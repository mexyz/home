...
<script type="text/javascript" src="../static/js/spend.js"></script>
</head>
...
<tr><td style="text-align: right;"><font color="red">*</font>时间：</td><td><input id="add_spend_date" name="spendDate" class="easyui-datebox" data-options="required:true,editable:false,width:144"/></td></tr>
...
<tr><td style="text-align: right;"><font color="red">*</font>时间：</td><td><input id="mod_spend_date" name="spendDate" class="easyui-datebox" data-options="required:true,editable:false,width:144"/></td></tr>
