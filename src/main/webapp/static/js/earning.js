$(function(){
    $('#dg').datagrid({
        ...
        columns:[[
			...
			{field:'earningDate',title:'收入时间',width:100,align:'center',sortable:true},
    ...
    $("#addBtn").click(function(){
        ...
        $('#add_earning_date').datebox('setValue', formatterDate(new Date()));
    ...
    $("#modBtn").click(function(){
		...
		if(rows.length==0){
	        ...
	        $("#modForm input[name='eId']").val(rows[0].eId);
	        $('#mod_earning_date').datebox('setValue', rows[0].earningDate);
